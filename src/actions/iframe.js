...
export const loadFromParent = (component, action, next) => {
  const response = {
    ...
    list: {
      98762: {
        ...
        user: {
          id: 8987,
          name: 'Cristi SelvaggioLoken',
          url: 'https://www.facebook.com/cristi.loken',
          image: 'https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-1/p160x160/10653562_933461080080555_2573322228358397722_n.jpg?oh=1eedb6c0c3e566eeca2dce54735988cb&oe=5938BEA4',
          affiliation: {
            name: 'Covina High',
        ...
        replies: {
          3: {
            ...
            user: {
              ...
              image: 'https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-1/p160x160/12208311_10207714506010947_4805234041899762623_n.jpg?oh=e3098b55290a2bca2074f411ce1650f1&oe=59314C51',
              affiliation: {
                name: '',
                url: '',
              },
...
// No need for next() since we aren't responding
export const saveToParent = (component, action) => {
  const { height } = action.payload;
  const $iFrame = $(component);
  if (`${height}px` !== $iFrame.css('height')) {
    $iFrame.css('height', `${height}px`);
